...
public enum ServiceInstancePosition {
	/** Instance is nearest to Client */
	FIRST,
	/** Instance is in the middle of the Service Chain */
	INNER,
	/** Instance is nearest to Content Provider */
	LAST,
	/** Instance is the only one in the Service Chain */
	FIRST_AND_LAST;
}
